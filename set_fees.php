						...
						<div class="module">
							...
							<div class="module-body">
									...
									<div class="alert alert-success">
										<button type="button" class="close" data-dismiss="alert">×</button>
										<strong>Done!</strong> You have successfully added new fee structure. 
									</div>

									<br />

									<form class="form-horizontal row-fluid" id="newstudentfrm" name="newstudentfrm" method="POST" action="db_set_fees.php" >
										...
										<div class="control-group">
											<label class="control-label" for="fee"> Amount </label>
											<div class="controls">
												<input type="text" id="fee" name="fee" placeholder="Enter amount" required class="span8">
										...
										<div class="control-group">
											<div class="controls">
												<button type="submit" class="btn" id="newstudent" >Set fee</button>
											</div>
										</div>
									</form>
							</div>
