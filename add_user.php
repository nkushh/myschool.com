					...
					<div class="content">
						...
						<div class="module">
							...
							<div class="module-body">
									...
									<form class="form-horizontal row-fluid" id="nteacherfrm" name="nteacherfrm" method="POST" action="db_insert_user.php" >
										<div class="control-group">
											<label class="control-label" for="firstname"> First Name </label>
											<div class="controls">
												<input type="text" id="fname" name="fname" placeholder="Enter user's First name" required class="span8">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="lname" name="lname" placeholder="Enter user's Last name" required class="span8">
												<!--<span class="help-inline">Helpful text here.</span>-->
											</div>
										</div>
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="username" name="username" placeholder="Enter user's Middle name" required class="span8">
												<!--<span class="help-inline">Helpful text here.</span>-->
											</div>
										</div>
										<div class="control-group">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="phone_no" name="phone_no" placeholder="Enter the user's phone number" required class="span8">
												<!--<span class="help-inline">Helpful text here.</span>-->
											</div>
										</div>
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="email" name="email" placeholder="Enter user's email address" required class="span8">
												<!--<span class="help-inline">Helpful text here.</span>-->
											</div>
										</div>
										<div class="control-group">
											...
											<div class="controls">
												<select tabindex="1" data-placeholder="Select here.." id="user_type" name="user_type" class="span8" required >
													<?php echo usertype(); ?>
												</select>
