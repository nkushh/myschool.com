					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3> Edit Event's Information </h3>
							</div>
							<div class="module-body">
									...
									<div class="alert alert-success">
										<button type="button" class="close" data-dismiss="alert">×</button>
										<strong>Done!</strong> You have successfully edited event's info. 
									</div>
									...
									<form class="form-horizontal row-fluid" id="newstudentfrm" name="newstudentfrm" method="POST" action="db_edit_studs.php" >
										...
										<div class="control-group">
											<label class="control-label" for="firstname"> Event name </label>
											<div class="controls">
												<input type="text" id="event_name" name="event_name" value="<?php echo $edit['event_name']; ?>" required class="span8">
										...
										<div class="control-group">
											...
											<div class="controls">
												<textarea class="span8" rows="5" name="details" value="<?php echo $edit['term']; ?>"></textarea>
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="eventdate"> Event date </label>
											<div class="controls">
												<select tabindex="1" data-placeholder="Select here.." id="day" name="day" value="<?php echo $edit['dates']; ?>" class="span8">
													<?php echo days();?>
												</select><br><br>
												<select tabindex="1" data-placeholder="Select here.." id="month" name="month" value="<?php echo $edit['dates']; ?>" class="span8">
													<?php echo months();?>
												</select><br><br>
												<select tabindex="1" data-placeholder="Select here.." id="year" name="year" value="<?php echo $edit['dates']; ?>" class="span8">
													<?php echo years();?>
												</select>
												<!--<span class="help-inline">Helpful text here.</span>-->
											</div>
										...
										<div class="control-group">
											<div class="controls">
												<button type="submit" class="btn" id="newstudent" >Save event Info</button>
											</div>
										</div>
									</form><? } ?>
							</div>
