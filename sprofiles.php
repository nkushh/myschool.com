					...
					<div class="content">
						...
						<div class="module">
							...
							<div class="alert">
										...
										<strong>Heads Up!</strong> You are currently viewing students in profile view. You can switch to <a href="liststudents.php" >List View </a>
									</div>
									<form>
									...
									<div class="row-fluid">
										<div class="span6">
											<div class="media user">
												...
												<div class="media-body">
													...
													<p><small class="muted">12 Yrs / Male / Class Four / Term Two / Self Sponsored </small></p>
										...
										<div class="span6">
											<div class="media user">
												...
												<div class="media-body">
													<h3 class="media-title">Grace Mutie</h3>
													<p><small class="muted">11 / Female / Class Three / Term Two / Sponsored</small></p>
													<div class="media-option btn-group shaded-icon">
														<button class="btn btn-small">
															<i class="icon-envelope-alt"></i>
														</button>
