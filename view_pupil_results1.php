...
$query="SELECT pupils.fname, pupils.lname, exam_results.adm_no, exam_results.class, exam_results.term, exam_results.year,
       ...
       exam_results.social_studies FROM pupils INNER JOIN exam_results ON pupils.adm_no = exam_results.adm_no WHERE exam_results.class = '$class'
       AND exam_results.term = '$term' AND exam_results.year = '$year' AND exam_results.exam_type = '$examtype'";
