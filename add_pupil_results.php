...
<head>
	...
	<title>Enter pupil's results'</title>
	<!-- STYLES: BOOTSTRAPS -->
					...
					<div class="content">
						...
						<div class="module">
							...
							<div class="module-body">
									...
									<form class="form-horizontal row-fluid" id="newstudentfrm" name="newstudentfrm" method="POST" action="db_pupil_results.php" >
										...
										<div class="control-group">
											...
											<div class="control-group">
												<label class="control-label" for="exam type"> Exam type </label>
												<div class="controls">
