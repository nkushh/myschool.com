			...
			<?php include "includes/sidebarnav.php"; ?>
				...
				<div class="span9">
					<div class="content">
						...
						<!-- button menus of the dashboard contains school, Library and finance. -->
						<?php include "includes/dashboardbar.php"; ?>


						<div class="module"><div class="module-head"><h3><font color="white">School Performance</font></h3></div><div class="module-body">
