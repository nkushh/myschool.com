...
<?php
$year=$_POST["year"];
$query="SELECT * FROM kcpe_results WHERE year='$year'ORDER BY names";
		...
		<div class="navbar-inner">
			<div class="container">
				...
				<div class="nav-collapse collapse navbar-inverse-collapse">
					...
					<form class="navbar-search pull-left input-append" method="POST" action="view_kcpe_results.php">
				...
				<div class="span9">
					<div class="content">
						<div class="btn-group pull-right" data-toggle="buttons-radio">
										<a href="overall_kcpe.php" role="button" class="btn btn-primary" >Overall performance</a>
									</div>
						<div class="module">
							...
							<div class="alert">
										...
										<strong>Heads Up!</strong> You are currently viewing <?php echo $year;?> KCPE results.
									</div>
								<?php	
								echo "<table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" class=\"datatable-1 table table-bordered table-striped	 display\" width=\"100%\">";
									...
									while($kcpe_results=mysqli_fetch_assoc($result)){
										echo "<tr class=\"odd gradeX\">";
											...
											echo "<td>".$kcpe_results["names"]."</td>";
											//echo "<td>".$exam_results["sex"]."</td>";
											echo "<td>".$kcpe_results["index_no"]."</td>";
										...
										echo "<td>SCORE</td>";
										echo "<td>"?>
											<?php include("includes/get_mean.php");?>
											<?php echo "</td>";
											echo "</tr>";
								echo "</table>";?>
							</div>
