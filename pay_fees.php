					...
					<div class="content">
						...
						<div class="module">
							...
							<div class="module-body">
									...
									<form class="form-horizontal row-fluid" id="payfees" name="payfees" method="POST" action="db_pay_fees.php" >
										<div class="control-group">
											<label class="control-label" for="admission number"> Adm No </label>
											<div class="controls">
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<input type="text" id="amount" name="amount" value="" placeholder="Enter cash paid" required class="span8">
												<!--<span class="help-inline">Helpful text here.</span>-->
											</div>
										</div>
