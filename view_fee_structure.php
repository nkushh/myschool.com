...
<?php
$query="SELECT * FROM fee_structure WHERE year='2014' ORDER BY id ASC";
				...
				<div class="span9">
					<div class="content">
						<div class="btn-group pull-right" data-toggle="buttons-radio">
										<a href="set_fees.php" role="button" class="btn btn-primary" >Set Fee</a>&nbsp &nbsp
										<a href="#myModalactivity" role="button"  data-toggle="modal" class="btn btn-success" >Search Fee structure</a>
									</div>
						...
						<div class="module">
							...
							<div class="alert">
										...
										<strong>Heads Up!</strong> You are currently viewing Fee structure.
									</div>
							<?php
