					...
					<div class="content">
						...
						<div class="module">
							...
							<div class="module-body">
									...
									<form class="form-horizontal row-fluid" id="newstudentfrm" name="newstudentfrm" method="POST" action="db_lend_book.php" >
										...
										<div class="control-group">
											...
											<div class="controls">
																<input type="text" id="book_title" name="book_title" placeholder="Enter book's title" required class="span8">
												<!--<span class="help-inline">Helpful text here.</span>-->
											</div>
										</div>
										<div class="control-group">
										...
										<div class="control-group">
											<label class="control-label" for="borrowdate"> Borrow date </label>
											<div class="controls">
										...
										<div class="control-group">
											...
											<div class="controls">
												<select tabindex="1" data-placeholder="Select here.." id="day2" name="day2" class="span8">
													<?php echo days();?>
												</select><br><br>
												<select tabindex="1" data-placeholder="Select here.." id="month2" name="month2" class="span8">
													<?php echo months();?>
												</select><br><br>
												<select tabindex="1" data-placeholder="Select here.." id="year2" name="year2" class="span8">
													<?php echo years();?>
												</select>
												<!--<span class="help-inline">Helpful text here.</span>-->
											</div>
										...
										<div class="control-group">
											<div class="controls">
												<button type="submit" class="btn" id="newstudent" >Submit</button>
											</div>
										</div>
									</form>
							</div>
