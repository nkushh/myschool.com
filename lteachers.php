				...
				<div class="span9">
					<div class="content">
						<div class="btn-group pull-right" data-toggle="buttons-radio">
										<a href="nteacher.php" role="button" class="btn btn-primary">Add teacher</a>
									</div>
						<div class="module">
							...
							<div class="alert">
										...
										<strong>Heads Up!</strong> You are currently viewing Teachers in list view. You can switch to <a href="pteachers.php" >Profile View </a>
									</div>
									<?php
								echo "<table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" class=\"datatable-1 table table-bordered table-striped	 display\" width=\"100%\">";
									...
									while($teacher=mysqli_fetch_assoc($result)){
										$view_subject=json_decode($teacher["subjects"], TRUE);
										echo "<tr class=\"odd gradeX\">";
											echo "<td>".$teacher["fname"]."&nbsp".$teacher["mname"]."&nbsp".$teacher["lname"]."</td>";
											echo "<td>".$teacher["sex"]."</td>";
											echo "<td>".$teacher["email"]."</td>";
											echo "<td>".$teacher["phone_no"]."</td>";
											echo "<td>";
											foreach($view_subject as $subject){

											echo $subject['subject']."&nbsp";
											}
											echo "</td>";
