					...
					<div class="content">
						...
						<div class="module">
							...
							<div class="alert">
										...
										<strong>Heads Up!</strong> You are currently viewing Teachers in profile view. You can switch to <a href="lteachers.php" >List View </a>
									</div>
									<form>
									...
									<div class="btn-group pull-right" data-toggle="buttons-radio">
										<button type="button" class="btn">All</button> <!-- jquery code to hide an show forms based on the selected button -->
									...
									<div class="row-fluid">
										<div class="span6">
											<div class="media user">
												...
												<div class="media-body">
													...
													<p><small class="muted">Subject Teaching : English <br/> Department : Languages <br/> Date Joined : 03/11/2005 </small></p>
										...
										<div class="span6">
											<div class="media user">
												...
												<div class="media-body">
													<h3 class="media-title">Milcah Shiku</h3>
													<p><small class="muted">Subject Teaching : Mathematics <br/> Department : Mathematics <br/> Date Joined : 03/11/2007 </small></p>
													<div class="media-option btn-group shaded-icon">
														<button class="btn btn-small">
															<i class="icon-envelope-alt"></i>
														</button>
