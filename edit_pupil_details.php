					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3> Edit Pupil's Information </h3>
							</div>
							<div class="module-body">
									...
									<div class="alert alert-success">
										<button type="button" class="close" data-dismiss="alert">×</button>
										<strong>Done!</strong> You have successfully edited pupil's info. 
									</div>

									<br />

									<form class="form-horizontal row-fluid" id="newstudentfrm" name="newstudentfrm" method="POST" action="db_edit_studs.php" >
										<input type="hidden" name="id" value ="<?php echo $id; ?>">
										<div class="control-group">
											<label class="control-label" for="firstname"> Surname </label>
											<div class="controls">
												<input type="text" id="surname" name="surname" value="<?php echo $edit['surname']; ?>" required class="span8">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="fname" name="fname" value="<?php echo $edit['fname']; ?>" required class="span8">
												<!--<span class="help-inline">Helpful text here.</span>-->
											</div>
										</div>
										<div class="control-group">
											...
											<div class="controls">
																<input type="text" id="lname" name="lname" value="<?php echo $edit['lname']; ?>" required class="span8">
												<!--<span class="help-inline">Helpful text here.</span>-->
											</div>
										</div>
										<div class="control-group">
											...
											<div class="controls">
												<?php if($edit["sex"]=="male"): ?>
												<label class="radio inline">
													<input type="radio" name="sex" id="gender" checked="checked" value="male" required >
													Male
												</label>
												<? else:?>
												<label class="radio inline">
													<input type="radio" name="sex" id="gender" checked="checked" value="female" required >
													Female
												</label>
												<?php endif;?> 
										...
										<p style="margin-left:180px; margin-bottom:-5px;" >Not <b><? echo $edit["sex"];?></b>?</p>
										<div class="control-group">
											<label class="control-label"> Sex </label>
											<div class="controls">
												<label class="radio inline">
										...
										<div class="control-group">
											...
											<div class="controls">
												<select tabindex="1" data-placeholder="Select here.." id="day" name="day" value="<?php echo $edit['day']; ?>" class="span8">
													<?php echo days();?>
												</select><br><br>
												<select tabindex="1" data-placeholder="Select here.." id="month" name="month" value="<?php echo $edit['month']; ?>" class="span8">
													<?php echo months();?>
												</select><br><br>
												<select tabindex="1" data-placeholder="Select here.." id="year" name="year" value="<?php echo $edit['year']; ?>" class="span8">
													<?php echo years();?>
												</select>
												<!--<span class="help-inline">Helpful text here.</span>-->
											</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<select tabindex="1" data-placeholder="Select here.." id="class" name="class" value="<?php echo $edit['class']; ?>" class="span8">
													<?php echo classes();?>
												</select>
											</div>
										</div>
										<div class="control-group">
											...
											<div class="controls">
												<select tabindex="1" data-placeholder="Select here.." id="term" name="term" value="<?php echo $edit['term']; ?>" class="span8">
													<?php echo terms();?>
												</select>
											</div>
										</div>
										<div class="control-group">
											...
											<div class="controls">
												<select tabindex="1" data-placeholder="Select here.." id="day1" name="day1" value="<?php echo $edit['doe']; ?>" class="span8">
													<?php echo days();?>
												</select><br><br>
												<select tabindex="1" data-placeholder="Select here.." id="month1" name="month1" value="<?php echo $edit['doe']; ?>" class="span8">
													<?php echo months();?>
												</select><br><br>
												<select tabindex="1" data-placeholder="Select here.." id="year1" name="year1" value="<?php echo $edit['doe']; ?>" class="span8">
													<?php echo years();?>
												</select>
												<!--<span class="help-inline">Helpful text here.</span>-->
											</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="adm_no" name="adm_no" value="<?php echo $edit['adm_no']; ?>" class="span8">
												<!--<span class="help-inline">Helpful text here.</span>-->
											</div>
										</div>
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="g_name" name="g_name" value="<?php echo $edit['g_name']; ?>" required class="span8">
										...
										<div class="control-group">
											...
											<div class="controls">
												<div class="input-prepend">
													<span class="add-on">+254</span><input class="span8" type="text" id="phone" name="phone_no" value="<?php echo $edit['phone_no']; ?>" required > &nbsp; &nbsp; <input class="span8" type="email" id="email" name="email" value="<?php echo $edit['email']; ?>" required >       
												</div>
											</div>
										</div>
										<!--<div class="control-group">
