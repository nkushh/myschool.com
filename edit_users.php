						...
						<div class="module">
							...
							<div class="module-body">
									...
									<div class="alert alert-success">
										<button type="button" class="close" data-dismiss="alert">×</button>
										<strong>Well done!</strong> You have successfully User's Information. 
									</div>

									<br />

									<form class="form-horizontal row-fluid" id="nteacherfrm" name="nteacherfrm" method="POST" action="db_edit_users.php" >
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="username" name="username" value="<?php echo $edit['username']; ?>" required class="span8">
												<!--<span class="help-inline">Helpful text here.</span>-->
											</div>
										</div>
										<div class="control-group">
											...
											<div class="controls">
												<label class="radio inline">
													<input type="radio" name="sex" id="sex" value="<?php echo $edit['sex']; ?>" required >
													Male
												</label> 
												<label class="radio inline">
													<input type="radio" name="sex" id="sex" value="<?php echo $edit['sex']; ?>" required >
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="phone_no" name="phone_no" value="<?php echo $edit['phone_no']; ?>" required class="span8">
												<!--<span class="help-inline">Helpful text here.</span>-->
											</div>
										</div>
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="email" name="email" value="<?php echo $edit['email']; ?>" required class="span8">
												<!--<span class="help-inline">Helpful text here.</span>-->
											</div>
										</div>
										<div class="control-group">
											...
											<div class="controls">
												<select tabindex="1" data-placeholder="Select here.." id="user_type" name="user_type" value="<?php echo $edit['user_type']; ?>" class="span8" required >
													<?php echo usertype(); ?>
												</select>
												<!--<span class="help-inline">Select major subject that the teacher is an expert.</span>-->
											</div>
										</div>
										<div class="control-group">
										...
										<div class="control-group">
											<div class="controls">
												<button type="submit" class="btn" id="newstudent" >Save User Info</button>
											</div>
										</div>
									</form><?}?>
							</div>
