...
<body>
		...
		<div class="navbar-inner">
			<div class="container">
				<a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
			  	...
			  	<a class="brand" href="#">
			  		CCM TOWNSHIP School Management System 
			  	</a>
		...
		<div class="container">
			<div class="row">
				<div class="module module-login span4 offset4">
					<form class="form-vertical" name="loginfrm" id="loginfrm" method="POST" action="verify.php" >
						...
						<div class="module-foot">
							<div class="control-group">
								<div class="controls clearfix">
									<button type="submit" id="login" class="btn btn-primary pull-right">Login</button>
									<label class="checkbox">
										<input type="checkbox" id="remember" name="remember" value="1" > Remember me
									</label>
									<div id="error"> </div> <!-- append jquery to display error -->
								</div>
							</div>
						</div>
					</form>
	...
	<div class="footer">
		<div class="container">
			...
			<b class="copyright">&copy; 2014 Piero Muguna</b> All rights reserved.
		</div>
	</div>
